...
|------|--------|--------|-------|
| [main_home](main_home.md) | canonical | [main-home](../schema/screens/main-home.screen.json) | Default landing feed; channel rail + banners + post stream + tab bar. |
...
| [main_company](main_company.md) | canonical | [main-company](../schema/screens/main-company.screen.json) | Company-scoped feed with company chip row, Overview banner, HOT/BEST eyebrows. |
...
| [compose](compose.md) | canonical | [compose](../schema/screens/compose.screen.json) | Post composition modal with Cancel/Post bar, pickers, title input, coaching banner. |

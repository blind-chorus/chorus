...
- **[`CONSUMING.md`](CONSUMING.md)** — how external projects consume Chorus. Lovable users: overlay the [`lovable-export/`](lovable-export) snapshot into your Lovable-connected repo (see CONSUMING.md §6).

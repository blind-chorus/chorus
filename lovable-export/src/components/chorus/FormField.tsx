...
import inputSpec from './specs/form-field/input.spec.json';
import searchBarSpec from './specs/form-field/search.spec.json';
import selectSpec from './specs/form-field/select.spec.json';
import { tokenToCss, typoStyles, joinClasses } from './spec-utils';
import { CloseCircleFillIcon, DownwardIcon, SearchIcon } from './icons/index';
...
/**
 * form-field family wrapper. Dispatches to a per-variant impl;
 * each variant's full prop contract lives in its own spec.
 *
 * @see ./specs/form-field/input.spec.json — variant="input" (default)
 * @see ./specs/form-field/search.spec.json — variant="search"
 * @see ./specs/form-field/select.spec.json — variant="select"
 */

...
/** Props for ProfileCarousel. Generated from schema/components/section/profile-carousel.spec.json — edit there, then re-run `npm run build:lovable`. */
export interface ProfileCarouselProps extends React.HTMLAttributes<HTMLDivElement> {
...
import { PulseFillIcon, StarFillIcon, ThumbUpFillIcon } from './icons/index';

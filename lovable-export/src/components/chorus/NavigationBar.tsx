...
import { BackwardIcon, CloseCircleFillIcon, MenuIcon } from './icons/index';
...
/**
 * navigation-bar family wrapper. Dispatches to a per-variant impl;
 * each variant's full prop contract lives in its own spec.
 *
 * @see ./specs/navigation-bar/home.spec.json — variant="home" (default)
 * @see ./specs/navigation-bar/page.spec.json — variant="page"
 * @see ./specs/navigation-bar/search.spec.json — variant="search"
 */

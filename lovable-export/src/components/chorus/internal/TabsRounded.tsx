...
/** Props for Tabs (rounded). Generated from schema/components/tabs/rounded.spec.json — edit there, then re-run `npm run build:lovable`. */
export interface TabsRoundedProps extends React.HTMLAttributes<HTMLDivElement> {
  variant: string;
...
/* Rounded Tabs container. Geometry is identical to Segmented (delegates
   ...
   attribute. */
export function TabsRounded({ fullWidth: _ignored, className, style, children, ...rest }: TabsRoundedProps) {

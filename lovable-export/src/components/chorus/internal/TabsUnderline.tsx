...
/** Props for Tabs (underline). Generated from schema/components/tabs/underline.spec.json — edit there, then re-run `npm run build:lovable`. */
export interface TabsUnderlineProps extends React.HTMLAttributes<HTMLDivElement> {
  variant: string;
...
import spec from '../specs/tabs/underline.spec.json';
...
export function TabsUnderline({ className, style, children, ...rest }: TabsUnderlineProps) {

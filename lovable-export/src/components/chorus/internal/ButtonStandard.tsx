...
/** Props for Button (standard). Generated from schema/components/button/standard.spec.json — edit there, then re-run `npm run build:lovable`. */
export interface ButtonStandardProps extends React.HTMLAttributes<HTMLButtonElement> {

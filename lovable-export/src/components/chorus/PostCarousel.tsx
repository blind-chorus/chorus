...
/** Props for PostCarousel. Generated from schema/components/section/post-carousel.spec.json — edit there, then re-run `npm run build:lovable`. */
export interface PostCarouselProps extends React.HTMLAttributes<HTMLDivElement> {
...
import { VerifiedFillIcon, ViewIcon } from './icons/index';

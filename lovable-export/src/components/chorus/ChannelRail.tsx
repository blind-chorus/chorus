...
/** Props for ChannelRail. Generated from schema/components/channel-rail/channel-rail.spec.json — edit there, then re-run `npm run build:lovable`. */
export interface ChannelRailProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  trailingAction?: Record<string, any>;

...
7. **[`keyscreens/`](keyscreens)** — canonical pixel references + per-screen notes (intent, tokens, components). Consult when matching a new composition to a signed-off visual target.

...
├── suggestion-list/              ← single-spec family
...
- **Full-specimen surfaces** (SuggestionList, AvatarRail, Feed, NavigationBar, Dialog, BottomSheet, full Tabs row, …) — flow at stage's full width (no wrapper, or `width: '100%'`). These *are* page chrome.
